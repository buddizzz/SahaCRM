  ...
  return (
    <div className="upload">
      ...
      <p className="upload-hint">
        الأعمدة المتوقعة: اسم المراجع، رقم الهوية، موعد الحجز، وقت بداية الموعد، تاريخ وصول المراجع، اسم
        الطبيب، اسم التخصص، رقم الاتصال. يتم التعرف على الأعمدة تلقائيًا حتى لو اختلفت مسمياتها قليلًا،
        باستثناء وقت بداية الموعد وتاريخ وصول المراجع اللذين يُطابقان بالاسم الحرفي فقط.
      </p>
    </div>
  );
}
