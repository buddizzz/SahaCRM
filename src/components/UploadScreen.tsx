  ...
  return (
    <div className="upload">
      ...
      <p className="upload-hint">
        الأعمدة المتوقعة: اسم المراجع، رقم الهوية، موعد الحجز، وقت بداية الموعد، اسم الطبيب، اسم التخصص،
        رقم الاتصال. يتم التعرف على الأعمدة تلقائيًا حتى لو اختلفت مسمياتها قليلًا، باستثناء عمود وقت
        بداية الموعد الذي يُطابق بالاسم الحرفي فقط.
      </p>
    </div>
  );
}
